...
QT_MOC_LITERAL(5, 46, 12) // "mAllProvince"
    ...
    "BarChart\0getModel\0\0QStandardItemModel*\0"
    "mModel\0mAllProvince"
};
...
void BarChart::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getModel((*reinterpret_cast< QStandardItemModel*(*)>(_a[1])),(*reinterpret_cast< QStringList(*)>(_a[2]))); break;
        default: ;
        }
